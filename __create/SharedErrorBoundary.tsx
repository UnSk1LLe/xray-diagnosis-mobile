...
import { safeSerializeError } from '../src/utils/safeSerializeError';
...
function InternalErrorBoundary({
    ...
    window.parent.postMessage(
      {
        ...
        error: safeSerializeError(errorArg),
      },
      '*'
    );
    setIsOpen(false);
  ...
  const handleCopyError = useCallback(() => {
    const serializedError = safeSerializeError(errorArg);
    const text = serializedError.stack
